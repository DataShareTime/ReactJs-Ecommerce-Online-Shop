...
const response  = await axios.post("localhost:8080/checkout",{
    product,
    token
});
 ...
 <div className="just-title">Total Price</div>
            <div className="items-price">${totalPrice}.00</div>
                        ...
                        <div className="stripe-section">
                            <StripeCheckout 
                            stripeKey="pk_test_51HQ5rNHUG4j5jGKjMCDgstTUFK1zKKFhiNFFAEaieN91fge411aiGCxOmq3lh8BE5L93iBlK8W4V7k5woWq22Wt100zUHbrXKx"
                            token={handleToken}
                            billingAddress
                            shippingAddress
